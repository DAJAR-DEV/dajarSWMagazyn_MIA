<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="address_pobranie.aspx.vb" Inherits="dajarSWMagazyn_MIA.address_pobranie" %>
    ...
    <div class="container">
        ...
        <div style="text-align: left; width: 100%;">
            ...
            <asp:Panel ID="PanelMagazyn" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <asp:label ID="Label10" runat="server" BackColor="WhiteSmoke" Font-Bold="True" ForeColor="Red">ZAKŁADKA POBRANIE TOWARU NA OPERATORA WOZEK</asp:label>
                <br/><br/>
                ...
                <div class="address-wymag-filter">
                    <div>
                        Filtrowanie wynikow : <asp:TextBox ID="TBFiltrowanie" runat="server" AutoPostBack="true" Width="250px"></asp:TextBox>
                    </div>
                        ...
                        <asp:Table ID="Table2" runat="server" Width="100%">
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="Left">
                                    <asp:Button ID="BTowarPobranie" runat="server" Text="POBIERZ TOWAR" BackColor="#FFCC00" Font-Bold="True" Font-Size="X-Large" Width="300px"/>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </asp:Panel>
