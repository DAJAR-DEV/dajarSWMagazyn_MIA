<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_dyspo_ext.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_dyspo_ext" %>
    ...
    <div style="text-align: left">
        ...
        <div>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <br/>
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium">Lista wszystkich dyspozycji w systemie :</asp:Label>
                ...
                <br/>
                Rok dokumentów : <asp:TextBox ID="TBRocznik" runat="server" AutoPostBack="true" Width="40px" MaxLength="4"></asp:TextBox>
                <br/>
                <br/>
                ...
                <p style="text-align:left; font-size: medium;">
                    <asp:Label ID="LMag700" runat="server" BackColor="Khaki" Text="MAG 700"></asp:Label>
                    &nbsp;&nbsp;
                    <asp:Label ID="LMag46" runat="server" BackColor="LightGray" Text="MAG 46"></asp:Label>
                    &nbsp;&nbsp;
