<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_label.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_label" %>
    ...
    <div style="text-align: left">
        ...
        <div>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium">Lista dyspozycji w systemie :</asp:Label>
                &nbsp;<asp:Label ID="LIleDokumentow" runat="server" Font-Bold="False" Font-Size="Medium"></asp:Label>
                <br/>
                Data nadania przesylki [YYYY-MM-DD] :
                <asp:TextBox ID="TBShippmentDate"
                             runat="server" AutoPostBack="true" Width="100px" MaxLength="10">
                </asp:TextBox>
                <br/>
                Filtrowanie danych etykiet : <asp:TextBox ID="TBFiltrowanie" runat="server" AutoPostBack="true" Width="250px"></asp:TextBox>
                <br/>
                <asp:CheckBox ID="CBFiltrowanieDHL" runat="server" AutoPostBack="True" Text="wyswietl tylko listy dhl"/>
                <br/>
                Data utworzenia etykiety [YYYY/MM]: <asp:TextBox ID="TBRocznik" runat="server" AutoPostBack="true" Width="55px" MaxLength="7"></asp:TextBox>
                <br/>
                <br/>
                ...
                <p style="text-align:left;">
                    <asp:Label ID="LPaczkaStandard" runat="server" BackColor="LightGray" Text="SH - numer wew.systemu"></asp:Label>
                    &nbsp;&nbsp;
                    <asp:Label ID="LPaczkaDHL" runat="server" BackColor="Gold" Text="DHL - numer list.przew."></asp:Label>
                    &nbsp;&nbsp;
                </p>
            </asp:Panel>
        </div>
