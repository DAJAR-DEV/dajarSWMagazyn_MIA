...
Partial Public Class address_wymag
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        BTowarWymagazynowanie.Attributes.Add("onclick", "javascrip:if(confirm ('Czy na pewno chcesz wymagazynowac wskazane artykuly?\n') == false) return false")
    ...
    Public Sub LadujDaneGridViewMagazyn(ByVal filtr As String)
        Using conn As New OracleConnection(dajarSWMagazyn_MIA.MyFunction.connString)
            ...
            If Session("mytyp_oper") = "W" Then
                If filtr <> "" Then
                    sqlexp = "select dt.skrot,r.nazdop,r.jm,r.kod_tow,r.skt2_0,r.klasa,dt.adres,dt.strefa,dt.is_active from dp_swm_mia_towary dt, ht_rejna r where dt.skrot = r.nazpot and r.is_deleted='N' and dt.strefa in('N','P','Z') and (dt.skrot like '" & filtr & "%' or dt.adres like '" & filtr & "%' or r.nazdop like '%" & filtr & "%') and dt.is_active=1 order by decode(dt.strefa, 'N', 1, 'P', 2, 'Z', 3), dt.skrot"
                Else
            ...
            If GridViewMagazyn.Rows.Count > 0 Then
                For Each row As GridViewRow In GridViewMagazyn.Rows
                    ...
                    If cb IsNot Nothing And cb.Checked Then
                        ...
                        sqlexp = "SELECT COUNT(*) FROM dp_swm_mia_towary WHERE adres='" & adres & "' and skrot='" & skrot & "' and strefa='" & strefa & "' and is_active='1'"
                        ...
                        If czy_istnieje <> "0" Then
                            ...
                            dajarSWMagazyn_MIA.MyFunction.SetHistoriaTowary(skrot, adres, strefa, is_active, "OP_WY", Session("mylogin"), Session("myhash"))
                        End If
                    End If
                Next
            End If
