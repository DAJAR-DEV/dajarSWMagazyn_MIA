<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_pakowanie.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_pakowanie" %>
    ...
    <div style="text-align: left">
        ...
        <div>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <br/>
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium">Lista dyspozycji pakowania w systemie :</asp:Label>
