<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_adresyAdd.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_adresyAdd" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" manifest="dswm.appcache">
<head id="Head1" runat="server">
    <title>Adresacja magazynu dodawanie - dajarSystemWspomaganiaMagazynu by MM</title>
...
<form id="formBody" runat="server">
    <div style="text-align: left">
        ...
        <div style="text-align: left; width: 100%;">
            ...
            <asp:Panel ID="Panel1" runat="server" GroupingText="Podstawowe informacje" BackColor="#EFF3FB">
                <asp:Table ID="Table4" runat="server" Width="100%">
                    <asp:TableRow>
                        ...
                        <asp:TableCell>regal od*</asp:TableCell>
                        <asp:TableCell>regal do*</asp:TableCell>
                        <asp:TableCell>polka od*</asp:TableCell>
                        <asp:TableCell>polka do*</asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLHala" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLRzad" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLRegalFrom" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLRegalTo" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLPolkaFrom" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="DDLPolkaTo" runat="server">
                            </asp:DropDownList>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            ...
            <asp:Button ID="BAdresAdd" runat="server" Text="UTWÓRZ NOWY ADRES" BackColor="#FFCC00" Font-Bold="True" Font-Size="X-Large" Width="300px"/>
        </div>
    </div>
</form>
</body>
