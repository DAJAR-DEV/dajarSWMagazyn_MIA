<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="address_auto_braki.aspx.vb" Inherits="dajarSWMagazyn_MIA.address_auto_braki" %>
    ...
    <div class="container">
        ...
        <div style="text-align: left; width: 100%;">
            ...
            <asp:Panel ID="PanelMagazyn" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                ...
                <br/><br/>
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium">Lista artykułów automagazynowania :</asp:Label>
