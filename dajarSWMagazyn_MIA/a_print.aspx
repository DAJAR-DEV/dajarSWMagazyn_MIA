<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_print.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_print" %>
    ...
    <div style="text-align: left">
        ...
        <div>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                ...
                <br/>
                Filtrowanie danych wydruków : <asp:TextBox ID="TBFiltrowanie" runat="server" AutoPostBack="true" Width="250px"></asp:TextBox>
                <br/>
                Data utworzenia wydruku :
                <asp:TextBox ID="TBRocznik" runat="server"
                             AutoPostBack="true" Width="39px" MaxLength="4">
                </asp:TextBox>
                <br/>
                <br/>
                <asp:GridView ID="GridViewDyspozycje" runat="server" CellPadding="5" Font-Size="Medium"
                              OnRowDataBound="GridViewDyspozycje_RowDataBound" OnPageIndexChanging="GridViewDyspozycje_PageIndexChanging"
                              Width="100%" AllowPaging="True" PageSize="50" AutoGenerateColumns="false" AutoGenerateSelectButton="true">
                    <PagerSettings Position="TopAndBottom" Mode="NumericFirstLast"/>
                    <PagerStyle HorizontalAlign="Right"/>
                    <SelectedRowStyle ForeColor="Red"/>
                    <HeaderStyle BackColor="#E5E5E5"/>
                    <Columns>
                        <asp:BoundField DataField="WYDRUK_ID" ReadOnly="true" HeaderText="WYDRUK_ID"/>
                        <asp:BoundField DataField="LOGIN" ReadOnly="true" HeaderText="LOGIN"/>
                        <asp:BoundField DataField="HASH" ReadOnly="true" HeaderText="HASH"/>
                        <asp:BoundField DataField="NR_ZAMOW" ReadOnly="true" HeaderText="NR_ZAMOW"/>
                        <asp:BoundField DataField="SCHEMAT" ReadOnly="true" HeaderText="SCHEMAT"/>
                        <asp:BoundField DataField="MAG" ReadOnly="true" HeaderText="MAG"/>
                        <asp:BoundField DataField="TYP_WYDRUK" ReadOnly="true" HeaderText="TYP_WYDRUK"/>
                        <asp:BoundField DataField="AUTODATA" ReadOnly="true" HeaderText="AUTODATA"/>
                        <asp:BoundField DataField="STATUS" ReadOnly="true" HeaderText="STATUS"/>
                        <asp:BoundField DataField="URL" ReadOnly="true" HeaderText="URL" Visible="false"/>
                        <asp:TemplateField HeaderText="PDF_LINK" SortExpression="PDF_LINK">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" Text='<%# Eval("WYDRUK_ID")%>' NavigateUrl='<%# Eval("URL")%>' runat="server" Target="_blank"></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <p style="text-align:left;">
                    <asp:Label ID="LWydrukBI" runat="server" BackColor="Khaki" Text="BI - wyd.ind. mag 700"></asp:Label>
                    &nbsp;&nbsp;
                </p>
            </asp:Panel>
        </div>
