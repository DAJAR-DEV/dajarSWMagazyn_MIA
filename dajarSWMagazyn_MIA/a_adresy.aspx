<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_adresy.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_adresy" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" manifest="dswm.appcache">
<head id="Head1" runat="server">
    <title>Adresacja magazynu - dajarSystemWspomaganiaMagazynu by MM</title>
    ...
    <div style="text-align: left">
        ...
        <div style="text-align: left; width: 100%;">
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium">Lista wszystkich adresow w systemie :</asp:Label>
                ...
                <br/>
                <asp:CheckBox ID="CBFiltrowanieSkrot" runat="server" AutoPostBack="True" Text="wyszukaj kod dajar na magazynie"/>
                <br/>
                <br/>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="a_adresyAdd.aspx"
                               CssClass="link">
                    # WPROWADZENIE NOWY ADRES NA MAGAZYNIE #
                </asp:HyperLink>
                <br/>
                <br/>
                <asp:GridView ID="GridViewAdresy" runat="server" AllowPaging="True"
                              CellPadding="5" AutoGenerateSelectButton="True" PageSize="50"
                              OnRowDataBound="GridViewAdresy_RowDataBound"
                              OnPageIndexChanging="GridViewAdresy_PageIndexChanging"
