<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="logout.aspx.vb" Inherits="dajarSWMagazyn_MIA.logout" %>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                <div class="login">
                    <div class="input">
                        ...
                        <asp:TextBox ID="TBUsername" runat="server" TextMode="SingleLine" ReadOnly="True"/>
                    </div>
                    <div class="input">
                        Hasło:
                    ...
                    <div class="input">
                        Rodzaj
                        <asp:DropDownList ID="DDLTypOperatora" runat="server" Enabled="False">
                    ...
                    <div class="input">
                        <asp:Button runat="server" ID="btnWyloguj" Text="Wyloguj"/>
                    </div>
                </div>
            </asp:Panel>
        </div>
