<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="a_manage.aspx.vb" Inherits="dajarSWMagazyn_MIA.a_manage" %>
    ...
    <div style="text-align: left">
        ...
        <div>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderColor="#333333" BorderStyle="None" BorderWidth="1px" Font-Size="Large" Width="100%">
                ...
                <br/>
                Wyszukiwanie numeru zamówienia : <asp:TextBox ID="TBSzukajNrZamow" runat="server" AutoPostBack="true" Width="250px"></asp:TextBox>
                <br/>
                Data dokumentów : <asp:TextBox ID="TBRocznik" runat="server" AutoPostBack="true" Width="55px" MaxLength="7">2015/07</asp:TextBox>
                <br/>
                <br/>
